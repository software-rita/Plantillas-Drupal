...
<section id=\"acknowledgment\" class=\"acknowledgment\">
    <div class=\"container\">
        ...
        echo "/SobreNosotros#documentos' class=\"card-link\">Ver más</a>
                    </div>
                </div>
                <div class=\"card\">
                    <div class=\"card-img-top\" style=\"background-image: url('";
        ...
        echo "');\"></div>
                    <div class=\"card-body\">
                        <h5 class=\"card-title\">Publicaciones y eventos</h5>
                        <hr>
                        <p class=\"card-text\">";
        // line 27
        ...
        // line 41
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->getUrl("<front>"));
        echo "/investigacion\" class=\"card-link\">Ver más</a>
                    </div>
                </div>
            </div>
        </section>
    ...
    {
        return new Source("", "themes/RITA/templates/node/node--logros-y-avances-inicio--full.html.twig", "/var/www/html/plantilla-unidades2/themes/RITA/templates/node/node--logros-y-avances-inicio--full.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("attach_library" => 1, "file_url" => 12, "url" => 19);
