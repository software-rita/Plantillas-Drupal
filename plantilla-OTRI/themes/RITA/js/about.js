!(function ($) {
  ...
  $(".members-carousel").owlCarousel({
    ...
    navText: [
      "<div class='icon-box icon-box-red w-100'><div class='icon'><i class='icofont-arrow-left'></i></div></div>",
      "<div class='icon-box icon-box-red w-100'><div class='icon'><i class='icofont-arrow-right'></i></div></div>"],
    loop: true,
    autoplay: true,
  ...
  $("#views-exposed-form-pdf-semilleros-pdf-documentos").appendTo("#filtro");
