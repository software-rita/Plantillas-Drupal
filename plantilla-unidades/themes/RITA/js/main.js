...
!(function ($) {
  ...
  $(document).ready(function () {
    $(window).on("popstate", function () {
      ...
      // if (url.includes('node?grupo')) {
      //   if (!url.includes('#Grupos')) {
      //     location.href = urlGlobal + "#Grupos";
      //   }
      // }
      // if (url.includes('node?semillero')) {
      //   if (!url.includes('#Semilleros')) {
      //     location.href = urlGlobal + "#Semilleros";
      //     console.log("llegue")
      //   }
      // }
      // if (url == "publicaciones" || url == "proyectos") {
      if (url == "Proyectos" || url == "proyectos" || url == "Publicaciones" || url == "publicaciones" || urlGlobal.includes("publicaciones") || urlGlobal.includes("investigacion")) {
  ...
  //Filtro grupos de investigacion y semilleros

  $("#views-exposed-form-vista-lineas-lineas").appendTo("#Filtro");
